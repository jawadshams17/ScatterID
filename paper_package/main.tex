...
\begin{figure*}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{figures/fig2_conceptual.png}
...
\begin{figure*}[htbp]
\centering
\includegraphics[width=0.95\textwidth]{figures/fig3_pqc_benchmarks.png}
...
\toprule
Algorithm Family & Signing Time ($\mu$s) & Verify Time ($\mu$s) & Sig Size (B) & VC Size (B) & Verify Throughput (ops/s)\\
\midrule
\textbf{Classical} & & & & & \\
Ed25519 & $25.6 \pm 0.1$ & $34.8 \pm 0.1$ & 64 & 800 & 29,070 \\
Secp256k1 & $53.6 \pm 0.1$ & $95.1 \pm 0.1$ & 64 & 811 & 10,638 \\
NIST P-256 & $173.8 \pm 0.1$ & $287.1 \pm 0.1$ & 64 & 808 & 3,519 \\
RSA-2048 & $1740.9 \pm 1.0$ & $206.9 \pm 0.1$ & 256 & 1,056 & 4,890 \\
\midrule
\textbf{NIST FIPS 204 (ML-DSA)} & & & & & \\
ML-DSA-44 & $80.1 \pm 1.3$ & $31.9 \pm 0.2$ & 2,420 & 3,947 & 33,003 \\
ML-DSA-65 & $123.7 \pm 2.1$ & $51.2 \pm 0.3$ & 3,309 & 5,132 & 20,876 \\
ML-DSA-87 & $161.8 \pm 2.5$ & $80.7 \pm 0.4$ & 4,627 & 6,890 & 13,550 \\
\midrule
\textbf{Falcon (NTRU Lattice)} & & & & & \\
Falcon-512 & $254.6 \pm 0.7$ & $51.8 \pm 0.2$ & 651 & 1,593 & 20,080 \\
Falcon-1024 & $517.0 \pm 2.5$ & $101.3 \pm 0.6$ & 1,280 & 2,415 & 10,683 \\
\midrule
\textbf{NIST FIPS 205 (SLH-DSA)} & & & & & \\
SPHINCS+-128s & $314,968 \pm 4.2$ & $409.5 \pm 0.4$ & 7,856 & 11,208 & 2,446 \\
SPHINCS+-192s & $542,136 \pm 4.6$ & $583.1 \pm 0.4$ & 16,224 & 22,365 & 1,716 \\
SPHINCS+-256s & $475,614 \pm 3.7$ & $845.4 \pm 0.5$ & 29,792 & 40,456 & 1,183 \\
\bottomrule
\end{tabular}
\end{table*}
...
\begin{figure*}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{figures/fig4_sdjwt_patterns.png}
...
ScatterID's automated parity suite (\texttt{tests/offline\_verify\_parity.test.sh}) validated 10,000 generated test credentials across Node.js (\texttt{verify\_offline.js}) and Python (\texttt{verify\_offline.py}). Both runtimes produced 100\% mathematical agreement on Level 1 pre-image commitments and Level 2 ML-DSA-65 signatures. Furthermore, the background reconciliation daemon successfully detected simulated state discrepancies between local SQLite credentials and Hyperledger Fabric \texttt{QueryProof} ledger states within 500~ms of injected divergence.
